...
<div style="
  ...
  border-radius: 20px;
  box-shadow: 0 0 20px #00eaff, inset 0 0 15px #004a55;
  background: rgba(0, 20, 30, 0.75);
  transform-style: preserve-3d;
  transition: 0.3s;
" onmousemove="this.style.transform='rotateY(10deg) rotateX(10deg)';"
   onmouseleave="this.style.transform='rotateY(0deg) rotateX(0deg)'">

  <h2 style="color:#00eaff; text-shadow:0 0 10px #00eaff;">🛰 Cyberpunk 3D Panel</h2>

  <img src="https://i.gifer.com/ZZ5H.gif" width="260" style="border-radius:15px; margin:10px;">
  <img src="https://raw.githubusercontent.com/rajpranav63/3D-Cube-Animation/main/cube.gif" width="260" style="border-radius:15px; margin:10px;">
  <img src="https://i.gifer.com/7VE.gif" width="260" style="border-radius:15px; margin:10px;">
